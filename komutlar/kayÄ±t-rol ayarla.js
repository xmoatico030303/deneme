...
message.reply("**Kayıt komutları kapalı açmak için !kayıtsistemi aç**")
      ...
      if( kullanıcı == "acik"){
if (!message.member.hasPermission("ADMINISTRATOR")) return message.reply(`:warning: Bu komutu kullanabilmek için **Yönetici** iznine sahip olmalısın!`);
  ...
  let role = message.mentions.roles.first()
    ...
    .setTitle(`» :white_check_mark: Kayıt olunca verilecek rol başarıyla **${role.name}** olarak ayarlandı! Rolü değiştirmek istersen tekrar etiketlemelisin.`)
    .setColor("RANDOM")

...
if(!rol) return message.channel.send(`:iptal: Ayarlamam İçin Bir Rol Etiketlemeilisin. 
...
:basarl: '${rol}' Olarak Güncelledim! 
:basarl: Kayıt Kanalını '${kanal}' Olarak Güncelledim!`)
